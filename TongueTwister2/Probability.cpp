...
void Probability::Gamma::discretization(std::vector<double> &catRate, double a, double b, size_t nCats, bool median) {
...
double  Probability::Uniform::pdf(double low, double high) {

    return 1.0 / (high - low);
}

double  Probability::Uniform::lnPdf(double low, double high) {
