...
class MatrixTemplate : public BufferTemplate<T> {
    ...
    public:
        ...
        T& operator()(size_t r, size_t c) { return this->begin()[r * numCols + c]; }
        const T& operator()(size_t r, size_t c) const { return this->begin()[r * numCols + c]; }
        ...
        T* getPointer(size_t r, size_t c) { return this->begin() + (r * numCols + c); }
        T getValue(size_t r, size_t c) const { return this->begin()[r * numCols + c]; }
        void setValue(size_t r, size_t c, T value) { this->begin()[r * numCols + c] = value; }
        ...
        void multiply(T scalar) { BufferTemplate<T>::multiply(scalar); }
